...
const CreatePoint = () => {
  ...
  const [intialPosistion, setIntialPosistion] = useState<[number, number]>([0, 0]);
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition(positon => {
      ...
      setIntialPosistion([latitude, longitude]);
    })
  }, [])
  ...
  useEffect(() => {
    ...
    axios.get<IBGECityResponse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`).then(respose => {
      const cityName = respose.data.map(city => city.nome);
      setCities(cityName);
    })
  }, [selectedUf]);
    ...
    <div id="page-create-point">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
          ...
          <Map center={intialPosistion} zoom={15} onclick={handleMapClick}>
            <TileLayer
